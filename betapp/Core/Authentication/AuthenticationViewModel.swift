...
//
// Changes made by simpleWare:
// - Removed the confirmPassword functionality to simplify the authentication flow.
// - Updated relevant logic to validate only email and password in the login and sign-up process.
...
class AuthenticationViewModel: ObservableObject {
    ...
    @Published var currentUserDocument: DocumentSnapshot?
...
private func dumpUser(_ user: User) {
    print(user.email ?? "Unknown email")
